...
<li><a href="<?php bloginfo('atom_url'); ?>" title="<?php _e('Syndicate this site using RSS','lightword'); ?>"><?php _e("<abbr title=\"Really Simple Syndication\">RSS</abbr>",'lightword'); ?></a></li>
